...
c1.prenom = "Brieuc"
c1.nom = "Lambert"
c1.date_de_naissance = DateTime.strptime("06/01/1993", "%m/%d/%Y")
...
c2.prenom = "Alizée"
c2.nom = "Wyart"
c2.date_de_naissance = DateTime.strptime("09/02/1993", "%m/%d/%Y")
...
c2.nationalite = "grece"
c2.save

c3 = Client.new
c3.prenom = "Jessica"
c3.nom = "Jones"
c3.date_de_naissance = DateTime.strptime("12/06/1987", "%m/%d/%Y")
